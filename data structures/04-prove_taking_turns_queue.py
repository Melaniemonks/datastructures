...
class Queue:
    ...
    def enqueue(self, value):
        ...
        """
        #the insert function inserts in the index function 0
        #self.queue.insert(0, value)

        #to add to the queue append needs to be used
...
# Defect(s) Found: names where not being appended. The insert function was used instead.
...
for i in range(10):
    players.get_next_person()
#print(players)    
# Defect(s) Found: There is no infinite condition
